...
def deployment_instance = 'staging.innovation.api.scio.services'
            ...
            steps {
                ...
                script {
                    sshagent(credentials: ['jenkins-ssh-key']) {
                        ...
                        sh "scp -r -P 1412 -o StrictHostKeyChecking=no ./nginx scio@${deployment_instance}:/var/lib/${project_name}-${stage_tag}"
